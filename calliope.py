...
critique_prompt = [
    {"role": "system",
     "content": "Edit like you're the editor for the New Yorker and you've got a bone to pick."},
    {"role": "user",
...
rewrite_stack = [
    {"role": "system",
     "content": "You are the vivid narrator, who describes the scene in exquisite detail."},
    {"role": "user",
     "content": (
